...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-4 animate-slideInRight">
            ...
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-green-500 to-cyan-500 text-white rounded-lg hover:from-green-600 hover:to-cyan-600 font-medium transition-all duration-300 btn-glow"
            >
              Sign Up
            </button>
          </div>
      ...
      <section className="relative z-10 px-6 py-20 sm:px-12 lg:py-32">
      ...
      <section className="relative z-10 px-6 py-16 sm:px-12 lg:py-24">
        <div className="max-w-7xl mx-auto">
      ...
      <footer className="relative z-10 border-t border-slate-800 glass-effect px-6 py-12 sm:px-12">
        <div className="max-w-7xl mx-auto">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-10">
                <a
                  ...
                  className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors duration-300 hover:scale-110 transform"
                >
                  <TwitterIcon />
                  <span>Twitter</span>
                </a>
